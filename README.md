...
## 🎯 Objective
Highly skilled and motivated Software Developer with 6+ months of experience at Sphinx Solutions Pvt. Ltd. Proficient in backend technologies like Java and frameworks such as Spring Boot. Seeking opportunities to utilize technical skills to solve real-world problems and build scalable applications.
...
- Performed SQL operations like INSERT, UPDATE, DELETE, and JOIN.
- Implemented retry logic, exception handling, and logging for reliability.
- Collaborated with team members to improve code quality and performance.
...
- Added login and role-based access for Admin, Employee, and Customer.
